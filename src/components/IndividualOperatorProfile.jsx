...
class IndividualOperatorProfile extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if(this.props.individualOperatorProfileSaved){
            this.props.updateIndividualOperatorProfile(this.state.profile);
        } else{
            this.props.setupIndividualOperatorProfile(this.state.profile);
        }
    }


    render() {
        const { savingIndividualOperatorProfile, individualOperatorProfileSaved, errors} = this.props;
                  ...
                  <div className="grid-container">
                    <div className="grid-x grid-padding-x">
                      <div className="large-12 cell">
                        ...
                        { submitted && ( !errors || errors.length === 0)  &&  individualOperatorProfileSaved && <p> Successfully Saved Operator Profile <br/></p>}
                        ...
                        <div className="grid-container">
                            <div className="grid-x grid-padding-x">
                               ...
                               <div className="large-6 cell">
                                    <button type="submit" className="button" name="button">{individualOperatorProfileSaved ? 'Update' : 'Submit' }</button>
                                    {
